...
/******/ 	return __webpack_require__(__webpack_require__.s = "./assets/js/messenger.js");
/******/ })
/************************************************************************/
/******/ ({
...
/* WEBPACK VAR INJECTION */(function($) {function sendMessage(form) {
...
$(function () {
    ...
    if ($('#png-choose').length > 0) {
        loadTypeAHead($('#png-choose'), $('#png-choose').data('source')).bind('typeahead:select', function (event, suggestion) {
            document.location.href = document.location.pathname + '?png-id=' + suggestion.id;
        });
    }
    loadTypeAHead($('#pg-choose'), $('#pg-choose').data('source')).bind('typeahead:select', function (event, suggestion) {
